...
export default defineSchema({
  master_sku: defineTable({
    ...
    client_sell_in_price: v.optional(v.number()),
  ...
  }).index('by_date', ['report_date']).index('by_barcode_warehouse_date', ['barcode', 'warehouse_name', 'report_date']),
  ...
  }).index('by_invoice_number', ['invoice_number']).index('by_po_number', ['po_number']),
